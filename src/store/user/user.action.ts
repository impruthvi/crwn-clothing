...
export type GoogleSignInStart = Action<USER_ACTION_TYPE.GOOGLE_SIGN_IS_START>;
...
export type SignInFaield = ActionWithPayload<
  USER_ACTION_TYPE.SIGN_IN_FAILED,
  Error
>;

export type SignUpFaield = ActionWithPayload<
...
export const googleSignInStart = withMatcher(
  (): GoogleSignInStart => createAction(USER_ACTION_TYPE.GOOGLE_SIGN_IS_START)
);
